...
const LOOKS_STAKING = '0x3ab16Af1315dc6C95F83Cbf522fecF98D00fd9ba'
...
const DEPLOYMENT_NAME = 'LooksCapacitorV3'
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  const capacitorDeployment = await deployments.deploy('FlyzLOOKSCapacitorV3', {
    from: deployer,
    args: [
      FLYZ,
      LOOKS,
  ...
  // update bond to use new capacitor
  await executeTx(
    'update bond to use new capacitor',
    bondDepositoryV2.setCapacitor(capacitor.address)
  )
}
